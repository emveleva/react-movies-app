...
import { fetchMovie, fetchLists, addToWatch, addWatched, removeToWatch, removeWatched } from '../../services/movieService'
    ...
    return (
        <main className={style.moviedetails}>
           ...
           <ul>
            ...
            <li>
            <hr />
            {!inToWatch && !inWatched && <p>This movie is not added to your movie lists.</p>}
            {inToWatch && inWatched && <p>This movie is in your <span>To-Watch</span> and <span>Already Watched</span> lists.</p>}
            {inToWatch && !inWatched && <p>This movie is in your <span>To-Watch</span> list.</p>}
            {!inToWatch && inWatched && <p>This movie is in your <span>Already Watched</span> list.</p>}
